...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyvue-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7432&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyvue-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyvue` can be installed with:

```
conda install ipyvue
```

It is possible to list all of the versions of `ipyvue` available on your platform with:
